...
// import Seeso from '../node_modules/seeso/dist/seeso.js'; // window is not defined 오류 발생

// 밑에 2줄도 window is not defined 에러 발생 - 이 에러를 고쳐보자..
// import Seeso from './seeso.min.js';
// const {InitializationErrorType, CalibrationAccuracyCriteria} = Seeso;

import Seeso from './seeso.js'
import InitializationErrorType from './seeso.js';
import CalibrationAccuracyCriteria from './seeso.js';
